...
const Feature199 = ({ features = [], image = "/images/placeholder.svg" }) => {
                            ...
                            {data.map((tab, index) => (
                                ...
                                >
                                    <AccordionTrigger className="py-5 hover:no-underline text-left group">
                                        <h3 className="text-base md:text-lg font-semibold text-gray-900 group-data-[state=open]:text-blue-500 transition-all duration-500">
                                            {tab.title}
                                        </h3>
                                    </AccordionTrigger>
