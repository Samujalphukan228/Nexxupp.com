...
const sections = [
    { id: "1", title: "Information We Collect", content: `We may collect personal information such as your name, email address, and project details when you contact us or use our services. This information is collected solely to provide our services and communicate effectively.` },
    { id: "2", title: "Use of Information", content: `The information we collect is used to:\n- Deliver our website services\n- Respond to inquiries and support requests\n- Send updates or announcements\n- Improve our offerings\n\nWe never sell or rent your personal information to third parties.` },
    { id: "3", title: "Cookies & Tracking", content: `We may use cookies or similar technologies for:\n- Website performance\n- Analytics purposes\n- Enhancing user experience\n\nThese cookies are non-invasive and only for internal use.` },
    { id: "4", title: "Data Retention", content: `Your personal information is retained only as long as necessary:\n- To provide services\n- To comply with legal obligations\n\nData no longer required is securely deleted or anonymized.` },
    { id: "5", title: "Third-Party Services", content: `We may share data with trusted third-party services, such as:\n- Hosting providers\n- Analytics tools\n\nThese providers are contractually obligated to maintain confidentiality and use data only for the intended purpose.` },
    { id: "6", title: "Contact", content: `For any questions regarding this Privacy Policy or your data, please contact us at contact@nexxupp.com.` },
];
